 ...
 */
export const useProjectGroup = (folderId) =>
  createQueryHook({
 ...
 */
export const useCreateProjectGroup = (options = {}) =>
  createMutationHook({
 ...
 * @returns {((function(*): Promise<FetchResult<any>>)|{data: any, called: boolean, loading: boolean, error: ApolloError})[]}
 */
export const useSaveProjectGroup = (options = {}) =>
  createMutationHook({
 ...
 * @returns {((function(*): Promise<FetchResult<any>>)|{data: any, called: boolean, loading: boolean, error: ApolloError})[]}
 */
export const useSaveProjectGroupsSorting = (options = {}) =>
  createMutationHook({
    ...
    options: {
      update(cache, { data: { updateProjectGroupsSorting } }) {
        ...
        const sortedProjectGroups = currentProjectGroups.map((projectGroup) => {
          const sortedProjectGroup = updateProjectGroupsSorting.find(
            (item) => item.id === parseInt(projectGroup.id)
          );
 ...
 * @returns {((function(*): Promise<FetchResult<any>>)|{data: any, called: boolean, loading: boolean, error: ApolloError})[]}
 */
export const useDeleteProjectGroup = (options = {}) =>
  createMutationHook({
